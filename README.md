...
- **Device Discovery** - Bidirectional UDP discovery repairs changed device IPs, including router-hosted servers; device-keyed collections and playback queues rehydrate automatically after an address change
