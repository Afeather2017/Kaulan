...
5. If tests pass, x86_64 + arm64 Windows and Linux desktop packages are built natively on the matching GitHub-hosted runners, and the three per-ABI Android APKs are built and attached.
